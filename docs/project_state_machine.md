...
- `T-STACKCHAN-OFFICIAL-HARDWARE-PARITY-001`
  ...
  - Next action: main control should dispatch
    `T-STACKCHAN-OFFICIAL-STATUS-DISPLAY-PARITY-001` for Gateway/protocol
    device-registry status-display parity before avatar/action, touch,
    diagnostic-sensor, firmware, camera, video, NFC, infrared, or
    app-lifecycle work.
