...
Current total state: `S-INTERNAL-TEST4-ROLEPLAY-RUNTIME-CONTRACT-READY-CLOUD-KNOWLEDGE-WORKSPACE-PLANNED-PHYSICAL-PENDING`
...
Cloud/Web/App plus V21 Knowledge Service/Adapter roadmap for public-only,
personal-only, and personal+public professional query scopes remains planned
work.
