...
- playback state-machine behavior for starting a speaking stream once, replacing streams with stop/clear, and stopping plus clearing immediately on barge-in
