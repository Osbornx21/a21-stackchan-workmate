...
| Screen touch | Official display touch can enter listen/config flows | Product-lane physical `screen_touch` report passed; not full official config-flow parity | Low-medium physical gate | `T-STACKCHAN-OFFICIAL-TOUCH-ACTION-EVIDENCE-001` | `reports/a21-stackchan-touch-acceptance-20260604-222700.json`, trace/session/device ids, source `screen` | Keep touch bridge behind product allowance if later screen behavior regresses |
| Top touch | Three-zone press/release/swipe gestures | Product-lane physical top tap, swipe forward/backward, and barge-in reports passed; directional swipes still need product affordance | Low-medium physical gate | `T-STACKCHAN-OFFICIAL-TOUCH-ACTION-EVIDENCE-001` | `reports/a21-stackchan-touch-acceptance-20260604-222708.json`, `...222719.json`, `...222744.json`, `...222818.json` with source `top_sensor` | Keep top touch bridge behind product allowance; keep directional swipe UX guided until labeling/training lands |
