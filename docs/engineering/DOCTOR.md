...
go run ./cmd/a21 stackchan-speaker-acceptance --gateway-url http://127.0.0.1:21080 --device-id stackchan-001 --commit <git-sha> --window-ms 1000 --mock-audio-chunks 50 --min-played-frames 50 --output-dir reports
make doctor
make lan-probe
