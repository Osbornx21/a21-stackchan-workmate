...
- `internal/gateway`: mock Gateway HTTP/WebSocket server, real-sized mock PCM downlink chunks, metrics, device registry, trace waterfall, and built-in simulator HTML.
