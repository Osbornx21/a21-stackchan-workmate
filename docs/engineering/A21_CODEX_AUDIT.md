...
- Firmware has disciplined Wi-Fi/Gateway/control/audio transport probes, full-size mock audio-frame uplink, bounded mock downlink buffering, a CoreS3 speaker pump build path, and a microphone capture policy with a speaker-busy guard, but it still does not claim real mic-to-Gateway streaming, physical speaker acceptance, VAD, full-duplex, or OTA.
