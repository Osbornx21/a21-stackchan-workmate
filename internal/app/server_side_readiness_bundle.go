...
func serverSideProductReadinessOptions(options serverSideReadinessBundleOptions) productReadinessOptions {
	productOptions := productReadinessOptions{
		...
		RoleplayVoiceReport:        options.RoleplayVoiceReport,
