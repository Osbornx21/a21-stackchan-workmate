...
func controlCommandSpecs() map[string]ControlCommandSpec {
	...
	return map[string]ControlCommandSpec{
		...
		"a21-stackchan-official-xiaozhi-compatible-flash-execute":   t7HardwareWrite("a21-stackchan-official-xiaozhi-compatible-flash-execute", "A21 official Xiaozhi compatible app flash execute"),
		"a21-stackchan-official-xiaozhi-compatible-nvs --execute":   t7HardwareWrite("a21-stackchan-official-xiaozhi-compatible-nvs --execute", "A21 official Xiaozhi compatible connection NVS write"),
		"a21-stackchan-official-xiaozhi-compatible-nvs-execute":     t7HardwareWrite("a21-stackchan-official-xiaozhi-compatible-nvs-execute", "A21 official Xiaozhi compatible connection NVS write"),
