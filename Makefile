...
a21-stackchan-official-xiaozhi-compatible-nvs-plan:
	...
	go run ./cmd/a21 a21-stackchan-official-xiaozhi-compatible-nvs --idf-export "$(A21_IDF_EXPORT)" --port "$(A21_UPLOAD_PORT)" --ota-url "$(A21_STACKCHAN_OFFICIAL_XIAOZHI_COMPATIBLE_OTA_URL)" --websocket-url "$(A21_STACKCHAN_OFFICIAL_XIAOZHI_COMPATIBLE_WEBSOCKET_URL)" --websocket-version "$(A21_STACKCHAN_OFFICIAL_XIAOZHI_COMPATIBLE_WEBSOCKET_VERSION)" --output-dir reports
...
a21-stackchan-official-xiaozhi-compatible-nvs-execute:
	...
	go run ./cmd/a21 a21-stackchan-official-xiaozhi-compatible-nvs --execute --idf-export "$(A21_IDF_EXPORT)" --port "$(A21_UPLOAD_PORT)" --ota-url "$(A21_STACKCHAN_OFFICIAL_XIAOZHI_COMPATIBLE_OTA_URL)" --websocket-url "$(A21_STACKCHAN_OFFICIAL_XIAOZHI_COMPATIBLE_WEBSOCKET_URL)" --websocket-version "$(A21_STACKCHAN_OFFICIAL_XIAOZHI_COMPATIBLE_WEBSOCKET_VERSION)" --confirm "$(A21_STACKCHAN_OFFICIAL_XIAOZHI_COMPATIBLE_NVS_CONFIRM)" --output-dir reports
